...
- Install BRAT plugin, **or** download the latest plugin release from <https://github.com/afforai/obsidian-logically-plugin/releases/latest> (obsidian-logically-plugin-0.5.0.zip for example, for release 0.5.0)
