      ...
      <div class="ra-settings-content">
        ...
        <div class="ra-settings-section">
          ...
          <p class="ra-section-desc">
            Optional. Add instructions to guide tone, format, or assumptions for
            every message.
          </p>
          <textarea
        ...
        <div class="ra-settings-section">
          ...
          <p class="ra-section-desc">
            To manage login, connection settings, or refresh your account, visit
            <button
              type="button"
              class="ra-link-btn"
              on:click={() => {
                ...
                appAny.setting?.open?.();
                appAny.setting?.openTabById?.(plugin.manifest.id);
                handleClose();
