<script lang="ts">
  ...
  const dispatch = createEventDispatcher<{ login: void; dismiss: void }>();
...
{#if isModal}
  <div
    class="ra-login-backdrop"
    on:click={handleBackdropClick}
    role="presentation"
  >
    <div class="ra-login-modal" role="dialog" aria-modal="true">
      <button
        class="ra-login-close"
      ...
      <div class="login-prompt login-prompt--modal">
        ...
        <div class="login-footer">
          ...
          >
          <button
            class="login-dismiss-link"
            on:click={() => dispatch("dismiss")}
            type="button">Continue without logging in</button
          >
        </div>
      </div>
    </div>
